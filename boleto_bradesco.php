...
$dadosboleto["demonstrativo1"] = $dadosboleto["instrucoes"]; //dado obtido de boleto.php
$dadosboleto["demonstrativo2"] = $dadosboleto["instrucoes1"];//dado obtido de boleto.php
$dadosboleto["demonstrativo3"] = $dadosboleto["instrucoes2"];//dado obtido de boleto.php

// INSTRUÇÕES PARA O CAIXA
$dadosboleto["instrucoes1"] = $dadosboleto["instrucoes4"];//dado obtido de boleto.php

...
/**Verifica se um número de documento é um CPF ou CNPJ, com ou sem os caracteres separadores.
* @author Manoel Campos da Silva Filho
* @param string $num_documento Número do documento a ser verificado o tipo
* @return string Retorna "cpf" se o número informado tiver
* o total de dígitos de um CPF (11, sem contar os separadores). Retorna "cnpj" se o número
* tiver o total de dígitos de um CNPJ (14, sem contar os separadores). 
* Senão, retorna uma string vazia*/
function tipo_documento($num_documento) {

...
table.line tr.campos p.sacador_avalista {
	height: 13px;
	font-family: 'Arial Narrow';
	font-size: 9px;
	color: navy;	
...
<div id="container">
	...
	<div id="instr_header">
		<strong><?php echo $dadosboleto["identificacao"]; ?> <?php echo isset($dadosboleto["cpf_cnpj"]) ? $dadosboleto["cpf_cnpj"] : '' ?></strong><br/>
 ...
 -->
		...
		<div id="instr_content">
			<p>
				...
				<strong>Instru&ccedil;&otilde;es abaixo:</strong>
			</p>
    ...
    <table cellspacing=0 cellpadding=0 width=666 border=0>
		...
		<div align=right>
		<b class=cp>Recibo do Sacado</b></div></TD></tr></tbody></table>
		...
		<tr class="campos">
			...
			<td class="carteira">
			<?php echo $dadosboleto["carteira"]?> <?php echo isset($dadosboleto["variacao_carteira"]) ? $dadosboleto["variacao_carteira"] : '&nbsp;' ?></td>
		...
		<tbody>
		<tr class="titulos">
			<td class="sacado2" colspan="2">Sacado</td>
		</tr>
		<tr class="campos">
			<td class="sacado2">
				<p>
        <?php 
          echo $dadosboleto["sacado"];
			    ...
			    if(tipo_documento($doc) == "cpf")
					  $doc = "CPF $doc";
          else if(tipo_documento($doc) == "cnpj") 
						$doc = "CNPJ $doc";
				  echo " / $doc";
        ?>
        </p>
        ...
        <p class="sacador_avalista">Sacador/Avalista</p>
			</td>
    ...
    <table cellspacing=0 cellpadding=0 width=666 border=0>
		<TBODY><TR><TD width=666 align=right >
			<font style="font-size: 10px;">Autentica&ccedil;&atilde;o mec&acirc;nica - Ficha de Compensa&ccedil;&atilde;o</font></TD></tr></tbody></table>
		<div class="barcode">
